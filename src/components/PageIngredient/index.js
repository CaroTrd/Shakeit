...
class PageIngredient extends Component {
    ...
    render() {
        const ingredients = ingredientList.map((elem, index) => (
            <li className="ingredient" key={index}>
            <div className="imagetexte">
                <img className="image"src={'https://www.thecocktaildb.com/images/ingredients/' + elem.strIngredient1 + '-Small.png'} alt="" />
                <p className="nameingredient">{elem.strIngredient1}</p>
            </div>
            </li>
        ))
        return (
        <div className = "wraper">
            <div className="page">
                <h1>SEARCH YOUR INGREDIENT HERE</h1>
